...
func refresh_screen(projectile: RigidBody3D, target: RigidBody3D) -> void:
	...
	$Data/HBoxContainer/VBoxContainer/Position/Value.text = proj_pos_str
	$Data/HBoxContainer/VBoxContainer/Velocity/Value.text = proj_vel_str
	$Data/HBoxContainer/VBoxContainer/Angle/Value.text = proj_rot_str
	...
	$Data/HBoxContainer/VBoxContainer2/Position/Value.text = tar_pos_str
	$Data/HBoxContainer/VBoxContainer2/Velocity/Value.text = tar_vel_str
	$Data/HBoxContainer/VBoxContainer2/Angle/Value.text = tar_rot_str

func set_label_name(name: String, pos: int) -> void:
	if pos == 0:
		$Data/HBoxContainer/VBoxContainer/Name.text = name
	elif pos == 1:
		$Data/HBoxContainer/VBoxContainer2/Name.text = name
